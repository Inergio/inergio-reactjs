        ...
        <div className="section__grid">
          ...
          <div className="item__wrapper">
            <section className="item">
              ...
              <div className="card__text">
                Responsabilidad, ética profesional, seguridad y eficacia son los valores que nos destacan como empresa líder y confiable. Asimismo, buscamos aportar al desarrollo de medidas de gestión de triple impacto: social, ambiental y económico, permitiendo así reinventar la cadena de valor. 
              </div>
            </section>
          </div>
          ...
          <div className="item__wrapper">
            <section className="item">
              ...
              <div className="card__text">
                Creemos que la atención personalizada es primordial, por lo tanto, cualquiera sea su actividad comercial o industrial, si estás interesado en nuestros servicios podes comunicarte al <a class="link link-primary" href="https://www.whatsapp.com/catalog/5493416590047/?app_absent=0">+ 54 9 (341) 659-0047</a>. También podes acceder a nuestras redes que se encuentran al final de está página o enviarnos un mail a ventas@inergio.com.ar / administracion@inergio.com.ar 
              </div>
            </section>
          </div>
        </div>
