        ...
        {name === 'productsAndServices' && (
          <div className="landing-section__slider swiper">
            ...
            <div className="swiper-wrapper swiper-wrapper--services">
              ...
              <div className="swiper-slide card card">
                <div className="card__image">
                  <img alt="" src={imagen1} loading='lazy' />
                </div>
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Desarrollamos y comercializamos proyectos integrales de climatización, proporcionando sistemas de aire acondicionado de alta calidad para una amplia gama de aplicaciones tanto en entornos comerciales o industriales.
                  </div>
                </div>
              </div>

              <div className="swiper-slide card card--services">
                <div className="card__image">
                  <img alt="" src={imagen1} loading='lazy' />
                </div>
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Nos especializamos en instalaciones comerciales e industriales, en sistemas convencionales y de bajo consumo. <br></br>Diseño, desarrollo y montaje de cámaras frigoríficas de baja y media temperatura.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Brindamos asesoramiento técnico y análisis de proyecto para sistemas de calefacción central, calderas, radiadores, termotanques de alta recuperación y calefactores eléctricos. <br></br>Realizamos la automatización de los diferentes sistemas y equipos.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Proporcionamos soluciones completas de inyección, extracción y renovación de aire. Diseñamos sistemas que favorecen un ambiente saludable, cómodo y, libre de contaminantes, que proporcionan un flujo de aire fresco y limpio en espacios cerrados.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Llevamos a cabo relevamiento, diseño y desarrollo de proyectos de instalaciones eléctricas. Identificamos los activos que deben repararse, renovarse o sustituirse para conseguir las objetivos de eficiencia energética.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Brindamos soluciones para ahorrar energía y así también reducir costos operativos. Desarrollamos proyectos, comercializamos materiales y productos, realizamos instalaciones y trámites para el programa ERA.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Proyecto, desarrollo, montaje y automatización de sistemas para cámaras de frío de baja y media temperatura.<br></br>Trasladables y multifuncionales: food truck, consultorios, oficinas, abrevaderos, etc. Con placas termoaislantes y termoacústicas.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Construcción de módulos autonómos y sustentables.<br></br>Los módulos están diseñados para funcionar de forma independiente de la red eléctrica y de los servicios públicos.<br></br>Están equipados con sistemas de energía renovable, como paneles solares y eólicos, que les permiten generar su propia electricidad.<br></br>También cuentan con sistemas de almacenamiento de energía, que les permiten almacenar el excedente de electricidad para su uso posterior.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Brindamos asesoramiento técnico y análisis de proyecto para sistemas de calefacción central, calderas, radiadores, termotanques de alta recuperación y calefactores eléctricos.<br></br> Realizamos la automatización de las diferentes sistemas y equipos.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    De climatización, refrigeración, calefacción y ventilación. Además de todo lo relacionada a la energía Fotovoltaica: paneles, termotanques, solares, inversores, etc
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Proponemos mejoras para establecer procesos más sostenibles que además generan una mayor eficiencia operacional elevando el rendimiento de las empresas e industrias.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Minimización de los costos operativos, prolongando el ciclo de vida del equipamiento, implementando sistemas y procedimientos de mantenimiento preventivo.
                  </div>
                </div>
              </div>
              ...
              <div className="swiper-slide card card--services">
                ...
                <div className="card__info">
                  ...
                  <div className="card__data">
                    Evolución y diagnóstico para detectar si es más rentable reparar o reemplazar un equipo, disponiendo de los costos de reparación y mantenimiento.
                  </div>
                </div>
              </div>
